...
import edu.neu.airline.emirates.entity.Flight;
import edu.neu.airline.emirates.entity.Passenger;
import edu.neu.airline.emirates.entity.vo.SearchVo;
import edu.neu.airline.emirates.repository.FlightRepository;
...
public class FlightService {
    ...
    public void deleteProxyFlight(String proxy_flight_number){
        ...
        Map<String, String> airlineUrlMap = new HashMap<>();
        airlineUrlMap.put("AC", "http://localhost:8091//removeProxy?flight_number="+proxy_flight_number+"&company_name=EK");
        airlineUrlMap.put("CA", "http://localhost:8092//removeProxy?flight_number="+proxy_flight_number+"&company_name=EK");
        airlineUrlMap.put("EK", "http://localhost:8093//removeProxy?flight_number="+proxy_flight_number+"&company_name=EK");
        airlineUrlMap.put("LH", "http://localhost:8094//removeProxy?flight_number="+proxy_flight_number+"&company_name=EK");
        airlineUrlMap.put("DL", "http://localhost:8095//removeProxy?flight_number="+proxy_flight_number+"&company_name=EK");
        RestTemplate restTemplate = new RestTemplate();
